...
const kv = {
  get: vi.fn(<T extends unknown>(key: string): Promise<T | undefined> => Promise.resolve(kvStore.get(key) as T | undefined)),                                                   
  set: vi.fn(<T extends unknown>(key: string, value: T): Promise<void> => {
