      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[card1, card2, card3].map((card, i) => (
              <motion.div key={i} style={card.animatedStyle}>
        ...
        <section className="space-y-6">
          ...
          <div className="flex gap-4">
            <motion.div style={morph.animatedStyle}>
        ...
        <section className="space-y-6">
          ...
          <div className="relative w-64 h-40" onClick={flipCard.flip}>
            <motion.div style={flipCard.frontAnimatedStyle} className="absolute inset-0">
            ...
            <motion.div style={flipCard.backAnimatedStyle} className="absolute inset-0">
        ...
        <section className="space-y-6">
          ...
          <motion.div style={glowBorder.animatedStyle}>
        ...
        <section className="space-y-6">
          ...
          <motion.div style={breathing.animatedStyle}>
        ...
        <section className="space-y-6">
          ...
          <motion.div style={wave.animatedStyle}>
