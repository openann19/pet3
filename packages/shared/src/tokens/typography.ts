/**
 * Design Token Typography - Shared Platform-Agnostic Values
 * Single source of truth for typography scale across web and mobile
 * 
 * Platform-specific adapters (Tailwind classes, React Native styles) should be
 * created in each app, but these values are shared.
 */
