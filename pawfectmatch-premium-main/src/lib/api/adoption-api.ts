...
export class AdoptionAPI {
  ...
  async updateListing(
    id: string,
    data: Partial<CreateAdoptionListingData>,
    ownerId: string
  ): Promise<AdoptionListing> {
    const listings = await this.getListings()
    ...
    // Update fields
    if (data.petName) listing.petName = data.petName
    if (data.petBreed) listing.petBreed = data.petBreed
    if (data.petAge !== undefined) listing.petAge = data.petAge
    if (data.petGender) listing.petGender = data.petGender
    if (data.petSize) listing.petSize = data.petSize
    if (data.petSpecies) listing.petSpecies = data.petSpecies
    if (data.petColor !== undefined) listing.petColor = data.petColor
    if (data.petPhotos) listing.petPhotos = data.petPhotos
    if (data.petDescription) listing.petDescription = data.petDescription
    if (data.fee !== undefined) listing.fee = data.fee
    if (data.locationCity) listing.location.city = data.locationCity
    if (data.locationCountry) listing.location.country = data.locationCountry
    if (data.locationLat !== undefined) listing.location.lat = data.locationLat
    if (data.locationLon !== undefined) listing.location.lon = data.locationLon
    if (data.requirements) listing.requirements = data.requirements
    if (data.vetDocuments) listing.vetDocuments = data.vetDocuments
    if (data.vaccinated !== undefined) listing.vaccinated = data.vaccinated
    if (data.spayedNeutered !== undefined) listing.spayedNeutered = data.spayedNeutered
    if (data.microchipped !== undefined) listing.microchipped = data.microchipped
    if (data.goodWithKids !== undefined) listing.goodWithKids = data.goodWithKids
    if (data.goodWithPets !== undefined) listing.goodWithPets = data.goodWithPets
    if (data.goodWithCats !== undefined) listing.goodWithCats = data.goodWithCats
    if (data.goodWithDogs !== undefined) listing.goodWithDogs = data.goodWithDogs
    if (data.energyLevel) listing.energyLevel = data.energyLevel
    if (data.temperament) listing.temperament = data.temperament
    if (data.specialNeeds !== undefined) listing.specialNeeds = data.specialNeeds
    if (data.reasonForAdoption) listing.reasonForAdoption = data.reasonForAdoption
