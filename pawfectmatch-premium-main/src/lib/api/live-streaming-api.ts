...
export class LiveStreamingAPI {
  ...
  async createRoom(
    ...
    /**
     * SECURITY WARNING: Placeholder tokens are used for development only
     * 
     * These tokens are NOT cryptographically secure and can be forged by any user.                                                                             
     * They do NOT provide authentication or authorization guarantees.
     * 
     * In production, tokens MUST be:
     * 1. Signed server-side using LiveKit SDK with proper JWT signing
     * 2. Include user identity and permissions
     * 3. Have expiration times
     * 4. Be generated by a secure backend service
     * 
     * DO NOT use these placeholder tokens in production environments.
     * 
     * Production implementation requires:
     * - Set up LiveKit server with API key/secret
     * - Create backend endpoint to sign tokens
     * - Include user identity, room permissions, and expiration
    ...
    /**
     * NOTE: LiveKit room creation should be handled server-side
     * 
     * This requires:
     * - LiveKit server instance running
     * - Server-side API endpoint to create rooms
  ...
  async endRoom(streamId: string, hostId: string): Promise<LiveStream> {
    ...
    /**
     * NOTE: Server-side composite to HLS and store VOD
     * 
     * This requires:
     * - LiveKit recording enabled
     * - Server-side storage for VOD files
    ...
    /**
     * NOTE: Close LiveKit room server-side
     * 
     * This requires:
     * - Server-side API endpoint to delete rooms
     * - Proper cleanup of room resources
     * 
     * Example implementation:
  ...
  async sendReaction(
    ...
    /**
     * NOTE: Broadcast reaction via WebSocket to all viewers
     * 
     * This requires:
     * - WebSocket server connection
     * - Real-time message broadcasting
     * - Connection management for viewers
     * 
     * Example implementation:
     * await broadcastToRoom(stream.roomId, {
     *   type: 'reaction',
  ...
  async sendChatMessage(
    ...
    /**
     * NOTE: Broadcast chat message via WebSocket to all viewers
     * 
     * This requires:
     * - WebSocket server connection
     * - Real-time message broadcasting
